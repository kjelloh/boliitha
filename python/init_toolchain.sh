...
echo "  python booli_scraper.py Uppsala # Scrape listings for a town"
echo ""
echo "Alternatively, use the run scripts (auto-activates venv):"
echo "  ./run_test.sh                   # Run test scraper"
echo "  ./run_scraper.sh Uppsala        # Scrape Uppsala listings"
echo "  ./run_scraper.sh Stockholm      # Scrape Stockholm listings"
echo ""
